...
//		driver.manage().window().maximize();
	...
	public void updateUser(String username, String password, String fullname, String email) {
		driver.get("http://localhost:8080/OnlineEntertaiment/dashboard/members/edit?id=user10");
		driver.findElement(By.xpath("/html/body/main/div/section/form/div[3]/input")).clear();
		driver.findElement(By.xpath("/html/body/main/div/section/form/div[3]/input")).sendKeys(fullname);
		driver.findElement(By.xpath("/html/body/main/div/section/form/div[4]/input")).clear();
		...
		driver.findElement(By.xpath("/html/body/main/div/section/form/button[2]")).click();
	}

	@Test(dataProvider = "InsertData")
	public void multiUpdate(String username, String password, String fullname, String email, String expected)
			throws InterruptedException {
		loginAdmin("user1", "123456");
		updateUser(username, password, fullname, email);
		...
		data.setEmail(email);
		data.setAction("Test Update User (authenticate) function");
	...
	public Object[][] data() throws IOException {
		...
		XSSFSheet sheet = workbook.getSheet("UPDATE-DATA");
		// doc du lieu test
