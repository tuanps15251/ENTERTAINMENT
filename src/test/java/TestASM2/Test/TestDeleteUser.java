...
//		driver.manage().window().maximize();
	...
	public void deleteUser(String username, String password, String fullname, String email) {
		driver.get("http://localhost:8080/OnlineEntertaiment/dashboard/members/edit?id=user10");
		driver.findElement(By.xpath("/html/body/main/div/section/form/button[3]")).click();
	}

	@Test(dataProvider = "InsertData")
	public void multiDelete(String username, String password, String fullname, String email, String expected)
			throws InterruptedException {
		loginAdmin("user1", "123456");
		deleteUser(username, password, fullname, email);
		...
		data.setEmail(email);
		data.setAction("Test Delete User (authenticate) function");
	...
	public Object[][] data() throws IOException {
		...
		XSSFSheet sheet = workbook.getSheet("DELETE-DATA");
		// doc du lieu test
