				...
				<div class="accordion-item">
					<h2 class="accordion-header" id="headingOne">
						<button class="accordion-button" type="button"
							...
							aria-expanded="true" aria-controls="collapseOne">Tìm các
							video yêu thích theo người sử dụng (nhập user id)</button>
					</h2>
						...
						<div class="accordion-body">
							...
							<section class="mb-4">
								<div class="container">
									...
									<form action="<c:url value = "/dashboard/find-video-user"/>"
										method="post">
										<!-- PASSWORD input -->
						...
						<div class="accordion-body">
							<section class="mb-4">
								<div class="container">
									...
									<form action="<c:url value = "/dashboard/find-video-title"/>"
										method="post">
										<div class="form-outline mb-4">
				...
				<div class="accordion-item">
					...
					<div id="collapseThree" class="accordion-collapse collapse"
						...
						<div class="accordion-body">
							...
							<section class="mb-4">
								<div class="container">
									<form action="<c:url value = "/dashboard/find-user-like"/>"
										method="post">
										<!-- PASSWORD input -->
										<div class="form-outline mb-4">
				...
				<div class="accordion-item">
					...
					<div id="collapseFour" class="accordion-collapse collapse"
						...
						<div class="accordion-body">
							...
							<section class="mb-4">
								<div class="container">
									<form action="<c:url value = "/dashboard/show-video-status"/>"
										method="post">
										<div class="btn-group">
										  <input type="radio" class="btn-check" name="favorite" id="favorite1" autocomplete="off" checked />
										  <label class="btn btn-secondary" for="favorite1">Favorite</label>
										
										  <input type="radio" class="btn-check" name="favorite" id="favorite2" autocomplete="off" />
										  <label class="btn btn-secondary" for="favorite2">Not Favorite</label>
										</div>
			...
			<div class="accordion-item">
					<h2 class="accordion-header" id="headingFive">
						<button class="accordion-button collapsed" type="button"
							...
							aria-expanded="false" aria-controls="collapseFive">Tổng hợp số lượt thích từng video theo cấu trúc</button>
					</h2>
						...
						<div class="accordion-body">
							<section class="mb-4">
								<div class="alert alert-danger" role="alert">
									<a href="<c:url value = "/dashboard/show-report-all"/>">Click to continue!</a>
								</div>
			...
			<div class="accordion-item">
					<h2 class="accordion-header" id="headingSix">
						<button class="accordion-button collapsed" type="button"
							...
							aria-expanded="false" aria-controls="collapseSix">Tìm các video được yêu thích có title chứa từ khóa (nhập từ khóa)</button>
					</h2>
					<div id="collapseSix" class="accordion-collapse collapse"
						...
						<div class="accordion-body">
							<section class="mb-4">
								<div class="container">
									<form action="<c:url value = "/dashboard/find-videolike-title"/>"
										method="post">
										<!-- PASSWORD input -->
										<div class="form-outline mb-4">
											<input type="text" id="keyword_title" name="keyword_title"
												class="form-control" value="" /> 
											<label class="form-label" for="keyword_title">Keyword title</label>
										</div>
				...
				<div class="accordion-item">
					<h2 class="accordion-header" id="headingSeven">
						<button class="accordion-button collapsed" type="button"
							...
							aria-expanded="false" aria-controls="collapseSeven">Tìm các video yêu thích theo người sử dụng (nhập user id)</button>
					</h2>
					<div id="collapseSeven" class="accordion-collapse collapse"
						...
						<div class="accordion-body">
							<section class="mb-4">
								<div class="container">
									<form action="<c:url value = "/dashboard/find-videolike-user"/>"
										method="post">
										<div class="form-outline mb-4">
											<input type="text" id="usernamelike" name="usernamelike"
												class="form-control" value="" /> 
											<label class="form-label" for="usernamelike">Username</label>
										</div>
				...
				<div class="accordion-item">
					<h2 class="accordion-header" id="headingEight">
						<button class="accordion-button collapsed" type="button"
							...
							aria-expanded="false" aria-controls="collapseEight">Tìm những video được thích trong khoảng thời gian</button>
					</h2>
					<div id="collapseEight" class="accordion-collapse collapse"
						aria-labelledby="headingEight" data-mdb-parent="#accordionExample">
						<div class="accordion-body">
							<section class="mb-4">
								<div class="container">
									<form action="<c:url value = "/dashboard/find-videolike-date"/>"
										method="post">
										<div class="form-outline mb-4">
											<input class="form-control datepicker" name="fromDate" type="date"/>
											<label class="form-label">From date?</label>
										</div>
										
										<div class="form-outline mb-4">
											<input class="form-control datepicker" name="toDate" type="date"/>
				...
				<div class="accordion-item">
					<h2 class="accordion-header" id="headingNine">
						<button class="accordion-button collapsed" type="button"
							...
							aria-expanded="false" aria-controls="collapseNine">Tìm những video được thích trong trong các tháng</button>
					</h2>
					<div id="collapseNine" class="accordion-collapse collapse"
						...
						<div class="accordion-body">
							<section class="mb-4">
								<div class="container">
									<form action="<c:url value = "/dashboard/find-videolike-month"/>"
										method="post">
										<div class="form-check form-check-inline">
										  <input class="form-check-input" type="checkbox" id="inlineCheckbox1" value="1" name="month" />
										  <label class="form-check-label" for="inlineCheckbox1">1</label>
										</div>
										
										<div class="form-check form-check-inline">
										  <input class="form-check-input" type="checkbox" id="inlineCheckbox2" value="2" name="month"/>
										  <label class="form-check-label" for="inlineCheckbox2">2</label>
										</div>
										
										<div class="form-check form-check-inline">
										  <input class="form-check-input" type="checkbox" id="inlineCheckbox3" value="3" name="month"/>
										  <label class="form-check-label" for="inlineCheckbox3">3 </label>
										</div>
										
										<div class="form-check form-check-inline">
										  <input class="form-check-input" type="checkbox" id="inlineCheckbox4" value="4" name="month"/>
										  <label class="form-check-label" for="inlineCheckbox4">4 </label>
										</div>
										
										<div class="form-check form-check-inline">
										  <input class="form-check-input" type="checkbox" id="inlineCheckbox5" value="5" name="month"/>
										  <label class="form-check-label" for="inlineCheckbox5">5 </label>
										</div>
										
										
										<div class="form-check form-check-inline">
										  <input class="form-check-input" type="checkbox" id="inlineCheckbox6" value="6" name="month"/>
										  <label class="form-check-label" for="inlineCheckbox6">6 </label>
										</div>
										
										<div class="form-check form-check-inline">
										  <input class="form-check-input" type="checkbox" id="inlineCheckbox7" value="7" name="month"/>
										  <label class="form-check-label" for="inlineCheckbox7">7 </label>
										</div>
										
										<div class="form-check form-check-inline">
										  <input class="form-check-input" type="checkbox" id="inlineCheckbox8" value="8" name="month"/>
										  <label class="form-check-label" for="inlineCheckbox8">8 </label>
										</div>
										
										<div class="form-check form-check-inline">
										  <input class="form-check-input" type="checkbox" id="inlineCheckbox9" value="9" name="month"/>
										  <label class="form-check-label" for="inlineCheckbox9">9 </label>
										</div>
										
										<div class="form-check form-check-inline">
										  <input class="form-check-input" type="checkbox" id="inlineCheckbox10" value="10" name="month"/>
										  <label class="form-check-label" for="inlineCheckbox10">10 </label>
										</div>
										
										<div class="form-check form-check-inline">
										  <input class="form-check-input" type="checkbox" id="inlineCheckbox11" value="11" name="month"/>
										  <label class="form-check-label" for="inlineCheckbox11">11 </label>
										</div>
										
										<div class="form-check form-check-inline">
										  <input class="form-check-input" type="checkbox" id="inlineCheckbox12" value="12" name="month"/>
				...
				<div class="accordion-item">
					<h2 class="accordion-header" id="headingTen">
						<button class="accordion-button collapsed" type="button"
							...
							aria-expanded="false" aria-controls="collapseTen">Truy vấn và hiển thị 10 video ngẫu nhiên</button>
					</h2>
					<div id="collapseTen" class="accordion-collapse collapse"
						...
						<div class="accordion-body">
							<section class="mb-4">
								<div class="alert alert-danger" role="alert">
									<a href="<c:url value = "/dashboard/show-random10-video"/>">Click to continue!</a>
								</div>
			...
			<div class="accordion-item">
					<h2 class="accordion-header" id="headingEleven">
						<button class="accordion-button collapsed" type="button"
							...
							aria-expanded="false" aria-controls="collapseEleven">Tổng hợp số lượt thích từng video theo năm có cấu trúc</button>
					</h2>
					<div id="collapseEleven" class="accordion-collapse collapse"
						aria-labelledby="headingEleven" data-mdb-parent="#accordionExample">
						<div class="accordion-body">
							<section class="mb-4">
								<div class="alert alert-danger" role="alert">
									<a href="<c:url value = "/dashboard/show-report-year"/>">Click to continue!</a>
								</div>
								<div class="container">
									<form action="<c:url value = "/dashboard/show-report-year"/>"
										method="post">
										<div class="form-outline mb-4">
											<select name="year">
